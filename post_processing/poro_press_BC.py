...
#  Pressure   Porosity
my_dir = first_part_of_path+'vis1e1_mR_01'       
...
def read_calculate_plot(filename, var_to_plot):
    ...
    df_h = myExp[int(res*res_y/2+2*res):int(res*res_y/2+3*res):1]    # dataframe only containing a horizontal line. start from the 50th element and skip 2 rows of 200 elements
    # print(len(df_v))
...
ax1.set_title("res*res_y/2+2*res")
