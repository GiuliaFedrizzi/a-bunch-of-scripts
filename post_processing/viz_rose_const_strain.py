...
from viz_functions import gallery,build_array,set_ax_options,find_variab,setup_array_const_strain_dbscan,find_dirs,setup_array_const_strain
...
x_variable = [2e-08, 4e-08, 6e-08, 7e-08, 8e-08]
...
for t in times:
    ...
    if variab == "viscosity":
        ...
        # rose_cs_bins10_defRate_mRate_t are generated by rose_new_bins, which lets me choose the bin size for the histogram
        filename = 'images_in_grid/rose_cs_bins10_defRate_mRate_t'
