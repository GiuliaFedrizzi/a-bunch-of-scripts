...
ax1.fill_between(all_data_h[vars_to_plot[0]][0], all_data_h[vars_to_plot[0]][1],all_data_h[vars_to_plot[1]][1]*5e8,interpolate=True,alpha=0.2)  # x, y1, y2
...
ax2.fill_betweenx(all_data_v[vars_to_plot[1]][0], all_data_v[vars_to_plot[0]][1],all_data_v[vars_to_plot[1]][1]*5e8,interpolate=True,alpha=0.2)  # y,x1,x2   between pressure and porosity 
