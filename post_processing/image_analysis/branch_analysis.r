...
if (TRUE) {
    ...
    labs(x = "Melt Rate",y = expression('B'[21]),colour = "Viscosity")
    ...
    labs(x = "Melt Rate",y = expression('B'[C]),colour = "Viscosity")
    ...
    labs(x = "Melt Rate",y = expression('B'[22]),colour = "Viscosity")
